...
bool DataBase::createTables()
{
    ...
    if(!query.exec( "CREATE TABLE " TABLE1 " ("
                    ...
                    TABLE1_FN     " VARCHAR(255),"
                    TABLE1_GND    " VARCHAR(255),"
                    TABLE1_PNUM   " VARCHAR(255),"
                    TABLE1_REGDT  " VARCHAR(255),"
                    TABLE1_SUBDR  " VARCHAR(255),"
                    TABLE1_PSTDT  " VARCHAR(255),"
                    TABLE1_PHOTO  " BLOB,        "
                    TABLE1_NOTDR  " VARCHAR(255) "
                " )"
            ) ||
        !query.exec( "CREATE TABLE " TABLE2 " ("
                    "id INTEGER PRIMARY KEY AUTOINCREMENT, "
                    TABLE2_LOG  " VARCHAR(255),"
                    TABLE2_PAS  " VARCHAR(255),"
                    TABLE2_QST  " VARCHAR(255),"
                    TABLE2_ANS  " VARCHAR(255) "
                " )"
            )
    ){
